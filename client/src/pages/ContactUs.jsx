        ...
        <>
            ...
            <section className="!py-12 !px-6 flex flex-col !justify-center !items-center !mb-10 md:!mb-20">
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="!mt-10 !mb-10 !px-10 text-center">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="Your Name"
                                      name="user_name"
                                    className="w-full md:w-[400px] !px-4 !py-3 rounded-lg bg-neutral-800 border border-neutral-700 focus:ring-2 focus:ring-gray-500 outline-none"
                                />
                            </div>
                            <div>
