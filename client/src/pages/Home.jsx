    ...
    <>
      ...
      <div id="home" className="home-container">
        ...
        <div className="heading">
          ...
          <p>
            We Craft Cybersecurity, IT, Software, and AI solutions that power
            growth and protect your digital future.
          </p>
      ...
      <div id="services" className="flex items-center justify-center !mb-[150px] md:!mb-28">
        <Services />
      </div>
      <div>
        <Story />
      ...
      <div className="!mt-32 !px-10 !pl-12">
        ...
        >
          <h1 className="text-4xl md:text-5xl !mb-4">What Our Clients Say</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl !mx-auto !mt-14 items-center justify-center">
          <a href="https://vr-gaming-gold.vercel.app/">
            <Feedback
              image={avatar}
              name="Rohit Sharma"
          ...
          <a href="https://msbline.vercel.app">
          <Feedback
            image={avatar}
            name="Ananya Verma"
          ...
          <a href="https://urbanabodes-realestate.vercel.app">
          <Feedback
            image={avatar}
            name="Karan Mehta"
